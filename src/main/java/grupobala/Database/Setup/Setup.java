...
public class Setup {
    ...
    private static void createTables(Statement statement) throws SQLException {
        String[] queries = {
            ...
            "INSERT INTO aula (videourl, duracaosegundos, idcurso, nome) VALUES ('https://www.youtube.com/watch?v=NFKQuJfXI4E', 1800, 1, 'Aula 1'), ('https://www.youtube.com/watch?v=NFKQuJfXI4E', 2100, 1, 'Aula 2')",
        };
