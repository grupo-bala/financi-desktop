...
public class TestExtract {
    ...
    public void TestExtractEntry() throws Exception {
        ...
        ITransaction transExampIn = new Transaction(
            1,
            100,
            "GiftCard",
        ...
        ITransaction transExampOut = new Transaction(
            2,
            -50,
            "BetsOnline",
        ...
        ITransaction transExampInTwo = new Transaction(
            3,
            65,
            "Gift",
            CategoryEnum.OTHERS,
        ...
        ITransaction transExampOutTwo = new Transaction(
            4,
            -25,
            "Snacks",
            CategoryEnum.FOOD,
        ...
        ITransaction transExampInThree = new Transaction(
            5,
            150,
            "Savings",
            CategoryEnum.OTHERS,
